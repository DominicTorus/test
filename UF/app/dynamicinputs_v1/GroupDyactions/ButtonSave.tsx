...
const ButtonSave = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
  ...
  const {secondscreeen_v1Props, setsecondscreeen_v1Props}= useContext(TotalContext) as TotalContextProps;
  let code:any = "";
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "0a80c928ce984132a0b90ee0ece69d9c",
          isTable: false,
          from:"ButtonSave",
  ...
  },[save69d9c?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    ...
    let filterProps:any =  [];
    let filterData = await getFilterProps(filterProps,dyactions87a65);
    setsecondscreeen_v1Props([...filterData ]);
     routes.push(getRouteScreenDetails('CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:CG:AFGK:TG3:AFK:secondscreeen:AFVK:v1', 'secondscreeen_v1'));
      await delay(1000);
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {save69d9c?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("Save")}
