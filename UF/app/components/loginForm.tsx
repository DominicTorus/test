...
const LoginForm = ({ logo, appName = "TG3", loginType = "standard", image }: LoginProps) => {
  ...
  const onBoardingKey : string = "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:CG:AFGK:TG3:AFK:DynamicInputs:AFVK:v1"
    ...
    try {
      if (tenant && formData.email && formData.password) {
        ...
        const api_signinBody: api_signinDto = {
          ...
          key: "CK:TGA:FNGK:BLDC:FNK:DEV:CATK:CT003:AFGK:CG:AFK:TG3:AFVK:v4:bldc",
          ufClientType: 'UFW'
        }
