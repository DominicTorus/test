...
const ButtonBtn1 = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "70dd7046d9f64396bd93ef2106a899aa",
          isTable: false,
          from:"ButtonBtn1",
  ...
  },[btn1899aa?.refresh,currentToken])
 ...
 if (btn1899aa?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `18 / 20`,gridRow: `41 / 57`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='normal'
          disabled= {btn1899aa?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("Btn1")}
