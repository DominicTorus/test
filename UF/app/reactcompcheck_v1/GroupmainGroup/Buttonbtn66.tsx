...
const Buttonbtn66 = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "260c9332b01d4556af1f6f2b84152747",
          isTable: false,
          from:"Buttonbtn66",
  ...
  },[btn6652747?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    if(maingroup81e1fProps?.validation==true && maingroup81e1fProps?.required==true || maingroup81e1fProps?.required==true)
    {
 ...
 if (btn6652747?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `14 / 16`,gridRow: `102 / 112`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='action'
          disabled= {btn6652747?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("btn66")}
