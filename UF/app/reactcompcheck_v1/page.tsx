...
export default function PageReactcompcheckV1() {
  ...
  const screenName:string = "reactcompcheck";
  ...
  const {reactcomp_v1Props, setreactcomp_v1Props} = useContext(TotalContext) as TotalContextProps;
  ...
  async function securityCheck() {
    const orchestrationData = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:CG:AFGK:TG3:AFK:reactComp:AFVK:v1",accessProfile:[user],from:"pageReactcompcheckV1"},{
      headers: {
