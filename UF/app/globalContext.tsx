...
export interface TotalContextProps {
  ...
  maingroup81e1f: any 
  setmaingroup81e1f: React.Dispatch<React.SetStateAction<any>>
  maingroup81e1fProps: any 
  setmaingroup81e1fProps: React.Dispatch<React.SetStateAction<any>>
  digroup04aa5: any 
  ...
  listdemod14c2: any,
  setlistdemod14c2:React.Dispatch<React.SetStateAction<any>>
  listdemod14c2Props: any 
  setlistdemod14c2Props: React.Dispatch<React.SetStateAction<any>>
  rbtn1862c0: any,
  setrbtn1862c0:React.Dispatch<React.SetStateAction<any>>
  rbtn1862c0Props: any 
  setrbtn1862c0Props: React.Dispatch<React.SetStateAction<any>>
  user1fe47c: any,
  setuser1fe47c:React.Dispatch<React.SetStateAction<any>>
  user1fe47cProps: any 
  setuser1fe47cProps: React.Dispatch<React.SetStateAction<any>>
  btn1899aa: any,
  setbtn1899aa:React.Dispatch<React.SetStateAction<any>>
  btn1899aaProps: any 
  setbtn1899aaProps: React.Dispatch<React.SetStateAction<any>>
  btn55667eb: any,
  setbtn55667eb:React.Dispatch<React.SetStateAction<any>>
  btn55667ebProps: any 
  setbtn55667ebProps: React.Dispatch<React.SetStateAction<any>>
  btn6652747: any,
  setbtn6652747:React.Dispatch<React.SetStateAction<any>>
  btn6652747Props: any 
  setbtn6652747Props: React.Dispatch<React.SetStateAction<any>>
  customw7f3cd: any,
  setcustomw7f3cd:React.Dispatch<React.SetStateAction<any>>
  customw7f3cdProps: any 
  setcustomw7f3cdProps: React.Dispatch<React.SetStateAction<any>>
  widget2416c9: any,
  setwidget2416c9:React.Dispatch<React.SetStateAction<any>>
  widget2416c9Props: any 
  setwidget2416c9Props: React.Dispatch<React.SetStateAction<any>>
  dyinputbae0f: any,
...
////// screen states 
  reactcomp_v1Props: any 
  setreactcomp_v1Props: React.Dispatch<React.SetStateAction<any>>
...
const GlobalContext = ({children} : {children: React.ReactNode}) => {
    const [currentToken, setCurrentToken ] = React.useState<any>({}) 
      //////////
        const [maingroup81e1f, setmaingroup81e1f ] = React.useState<any>({}) 
    const [maingroup81e1fProps, setmaingroup81e1fProps ] = React.useState<any>({
      validation:false,
      required:false,
      refetch:false,
      refresh:false,
   ...
   const [listdemod14c2,setlistdemod14c2] = React.useState<any>({
    isDisabled: false,
    presetValues: '',
    isHidden: false,
    refetch:false,
   ...
   const [rbtn1862c0,setrbtn1862c0] = React.useState<any>({
    isDisabled: false,
    presetValues: '',
    isHidden: false,
    refetch:false,
   ...
   const [user1fe47c,setuser1fe47c] = React.useState<any>({
    isDisabled: false,
    presetValues: '',
    isHidden: false,
    refetch:false,
   ...
   const [btn1899aa,setbtn1899aa] = React.useState<any>({
    isDisabled: false,
    presetValues: '',
    isHidden: false,
    refetch:false,
   ...
   const [btn55667eb,setbtn55667eb] = React.useState<any>({
    isDisabled: false,
    presetValues: '',
    isHidden: false,
    refetch:false,
   ...
   const [btn6652747,setbtn6652747] = React.useState<any>({
    isDisabled: false,
    presetValues: '',
    isHidden: false,
    refetch:false,
   ...
   const [customw7f3cd,setcustomw7f3cd] = React.useState<any>({
    isDisabled: false,
    presetValues: '',
    isHidden: false,
    refetch:false,
   ...
   const [widget2416c9,setwidget2416c9] = React.useState<any>({
    isDisabled: false,
    presetValues: '',
    isHidden: false,
    refetch:false,
   ...
   const [submit0245e,setsubmit0245e] = React.useState<any>({
    ...
    ///////////
    const [refresh, setRefresh] = React.useState<any>({       listlistDemod14c2:false,
       radiobuttonRbtn1862c0:false,
       avatarUser1fe47c:false,
       buttonBtn1899aa:false,
       buttonbtn55667eb:false,
       buttonbtn6652747:false,
       customwidgetcustomW7f3cd:false,
       customwidgetwidget2416c9:false,
       dynamicjsonformDyInputbae0f:false,
  ...
  ////// screen states 
   const [reactcomp_v1Props,setreactcomp_v1Props] = React.useState<any>([])
