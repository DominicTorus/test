...
export default function PageSecondscreeenV1() {
  ...
  const screenName:string = "dynamicinputs";
  ...
  async function securityCheck() {
    const orchestrationData = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:CG:AFGK:TG3:AFK:secondscreeen:AFVK:v1",accessProfile:[user],from:"pageSecondscreeenV1"},{
      headers: {
    ...
    if (token) {
      try {
        ...
        localStorage.clear();
        deleteAllCookies();
        window.location.href = '/ct003/cg/tg3/v4';
        }
      }catch (err: any) {
