...
const Buttonsubmit = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "3a54f4e3162444fea6ee4d911c63122e",
          isTable: false,
          from:"ButtonSubmit",
  ...
  },[submit3122e?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    if(digroup04aa5Props?.validation==true && digroup04aa5Props?.required==true || digroup04aa5Props?.required==true)
    {
 ...
 if (submit3122e?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `22 / 24`,gridRow: `178 / 191`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='action'
          disabled= {submit3122e?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("Submit")}
