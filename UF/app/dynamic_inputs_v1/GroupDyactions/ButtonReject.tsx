...
import PageSecondscreeenpage from '@/app/secondscreeen_v1/secondscreeen_v1page';
...
const ButtonReject = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "673fba83eb2b458293aa7a7dc75bd33d",
          isTable: false,
          from:"ButtonReject",
  ...
  },[rejectbd33d?.refresh,currentToken])
    ...
    <div
      ...
      className='w-[] h-[] bg-gray-50 mx-auto rounded-lg shadow-xl p-5 overflow-auto'>
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {rejectbd33d?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("Reject")}
