...
const Buttonbutton = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
  ...
  const handleClick=async()=>{
    if(firstgroupc08a7Props?.validation==true && firstgroupc08a7Props?.required==true || firstgroupc08a7Props?.required==true)
    {
 ...
 if (button6c543?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `2 / 6`,gridRow: `18 / 46`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='action'
          disabled= {button6c543?.isDisabled ? true : false}
          pin='brick-brick'
          needTooltip={true}  
