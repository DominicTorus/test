...
const Iconicon = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:CG:AFGK:TG1:AFK:propsCheck:AFVK:v1",  componentId:"c2cb1a49935b44419561e81deffc08a7",controlId:"9616f30de25e41a6b6cf6497c6b0a30c",isTable:false,accessProfile:accessProfile,from:"Iconicon"},{
      headers: {
  ...
  if (icon0a30c?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `8 / 11`,gridRow: `113 / 135`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      data="Md30FpsSelect"
