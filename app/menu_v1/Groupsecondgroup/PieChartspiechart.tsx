  ...
  const handleMapperDetails=async()=>{
    ...
    '/UF/Orchestration',
      {
        ...
        controlId: "cd6c04489c0f42639cb3785f8d34e57f",
        isTable: false,
        accessProfile:accessProfile,
        from:"checkboxpiechart"
      },
      {
        headers: {
    ...
    if (code != '') {
      ...
      if(Array.isArray(dfd_mydfddata_v1Props) && dfd_mydfddata_v1Props?.length > 0){
        ...
        setsecondgroup311a5((pre:any)=>({...pre,amount:dfd_mydfddata_v1Props[0]?.amount}))
      }
  ...
  if (piechart4e57f?.isHidden) {
   ...
   return (
    <div
      ...
      style={{gridColumn: `15 / 21`,gridRow: `21 / 65`, gap:``, height: `100%`}}
    >
      <PieChart
        data={data}
        showCurrencySign = "₹"
