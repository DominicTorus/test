...
const Textrevenuedf = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[revenuedfbd405?.refresh])

  if (revenuedfbd405?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 9`,gridRow: `72 / 80`, gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="body-3"
      color ="primary"
       ellipsis={true}
    >
    {isDynamic ? item?.revenuedf : (dynamic9403b?.revenuedf || "")}
    </Text> 
  </div>
  )
}

export default Textrevenuedf
