...
const Textrevenue = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[revenue95787?.refresh])

  if (revenue95787?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 5`,gridRow: `59 / 67`, gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="body-3"
      color ="primary"
