...
const Buttonview = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
  ...
  const {cname1a23c, setcname1a23c}= useContext(TotalContext) as TotalContextProps;
  const {view155e3, setview155e3}= useContext(TotalContext) as TotalContextProps;
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "5600fd7fd1574529af9fe99d6c2155e3",
          isTable: false,
          from:"ButtonView Details",
  ...
  const handleClick=async()=>{
    if(cgroupf48bfProps?.validation==true && cgroupf48bfProps?.required==true || cgroupf48bfProps?.required==true)
    {
